                            ...
                            {tracks.map((track, i) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`group flex items-center gap-3 md:gap-4 p-2.5 md:p-3 rounded-2xl transition-all animate-in fade-in slide-in-from-bottom-2 fill-mode-both cursor-pointer ${
                                            isCurrent
                                    ...
                                    >
                                        ...
                                        <span className={`w-8 text-center font-black text-sm tabular-nums ${
                                            rank <= 3 ? "text-orange-500" : "text-gray-300 dark:text-gray-600"
                                        }`}>
                                            {rank}
                                        </span>
