                                ...
                                {songs.map((track, i) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`group flex items-center gap-3 p-3 rounded-2xl transition-all animate-in fade-in slide-in-from-bottom-2 fill-mode-both cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-900/50 ${
                                                isCurrent ? "bg-pink-50 dark:bg-pink-900/10 border border-pink-200 dark:border-pink-800/30" : ""
                                            }`}
                                            onClick={() => isCurrent ? togglePlay() : playTrack(track, songs)}
                                        >
                                            ...
                                            <div className="flex items-center gap-1 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" onClick={(e) => e.stopPropagation()}>
                                                <button onClick={() => toggleFavorite(track)} className={`p-1.5 transition-all ${isFav ? "text-pink-500" : "text-gray-300 hover:text-pink-500"}`}>
