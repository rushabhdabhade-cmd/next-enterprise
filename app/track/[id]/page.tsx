        ...
        return (
            <div className="min-h-screen bg-white dark:bg-gray-950 flex items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <span className="text-sm font-medium text-gray-400 animate-pulse">Loading masterpiece...</span>
                </div>
            </div>
        )
    }
    ...
    if (!track) {
        return (
            <div className="min-h-screen bg-white dark:bg-gray-950 flex flex-col items-center justify-center p-8 text-center">
                ...
                <p className="text-gray-500 mb-8">This melody couldn&apos;t be found.</p>
                <button
                    onClick={() => router.back()}
                    className="px-6 py-2 border border-gray-200 dark:border-gray-800 rounded-full hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors"
                >
                    Go Back
                </button>
            </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center lg:items-end">
                        ...
                        <div className="flex-1 mb-4 text-center lg:text-left">
                            ...
                            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
                                ...
                                <button className="w-14 h-14 rounded-full border border-gray-200 dark:border-gray-800 flex items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-900 transition-all text-xl">
                                    <MoreHorizontal size={24} className="text-gray-400 hover:text-gray-900 dark:hover:text-white" />
                                </button>
                            </div>
                        </div>
                    </div>
